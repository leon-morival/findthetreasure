...
function findChest()
{
    ...
    if ($playerX === $chestX && $playerY === $chestY) {
        echo "Félicitations ! <br>Vous avez trouvé le trésor !";
        echo '<br>';
        echo "Position du joueur : " . $playerX . ' ' . $playerY;
        echo '<br>';
        echo "Position du trésor : " . $chestX . ' ' . $chestY;
    } else {
        echo "Continuez l'exploration...";
    }
}
