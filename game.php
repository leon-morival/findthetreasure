...
<body>
    ...
    <div class="container">
        ...
        <h2>Attention, nouvel aventurier !</h2>
            <p>Le chemin qui s'ouvre devant toi est rempli de dangers et de mystères. Le trésor légendaire que tu cherches est dit être gardé par des créatures redoutables.</p>
            <p>Partez à l'aventure et commencez :</p>
            <ul>
                <li>Pour te déplacer sur la carte, utilise les touches du clavier (ou clique directement sur les boutons) ;</li>
